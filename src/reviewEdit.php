	...
	<body class="antialiased font-inter bg-zinc-100 text-zinc-950">
		...
		<div class="w-full py-20">
			<div class="container px-2 mx-auto">
				...
				<div
					class="grid max-w-screen-lg grid-cols-1 gap-6 mx-auto mt-20 xl:grid-cols-4">
					<div class="col-span-1 xl:col-span-3">
						<input
								type="text"
								class="w-full p-4 italic font-bold bg-white border-2 rounded-xl border-zinc-200"
								placeholder="Tulis judul ulasan"
								value="Love This AYCE <3" <!-- Add this line to set a default value --/>
						...
						<textarea
								...
								placeholder="Tulis deskripsi ulasan maks. 200 huruf"
						>Saya sangat merekomendasikan restoran all you can eat ini! Harga terjangkau, rasa enak, ambience yang nyaman, dan kebersihan terjaga dengan baik.</textarea> <!-- Add default text between the tags -->

						<!-- Add default values for other form fields as needed -->
						...
						<div
							...
							<span
								class="mr-2 material-symbols-outlined text-zinc-200">
								camera
							</span>
						...
						<div class="col-span-1">
							...
							<input
									...
									value="Buffet Premium" <!-- Set default value for the menu input --
							/>
							...
							<input
									type="date"
									class="w-full p-4 mt-4 italic font-bold bg-white border-2 rounded-xl border-zinc-200"
									value="2023-11-25" <!-- Set default value for the date input --
							/>
							...
							<input
									type="number"
									class="w-full p-4 mt-4 italic font-bold bg-white border-2 rounded-xl border-zinc-200"
									value="150.000" <!-- Set default value for the price input --
							/>
					</div>
				...
				<div
					class="flex items-center justify-center w-full max-w-screen-lg mx-auto mt-8 space-x-4 lg:justify-end">
					<button
						id="submitReviewBtn"
