    ...
    <section class="login d-flex">
        <div class="login-right w-2\/4 h-100">
            <div class="header">
                    ...
                    if (count($errors) > 0) {
                        ...
                        if ($stmt) {
                            if (mysqli_stmt_prepare($stmt, $sql)) {
                                ...
                                echo "<div class='alert alert-success'>You are registered successfully. Go to <a href=login.php>login page</a></div>";
                ...
                <input class="form-check-input mt-3" type="checkbox" id="inlineCheckbox1" value="option1">
                <label class="form-check-label mt-3" for="inlineCheckbox1">Setuju dengan syarat dan ketentuan</label>
